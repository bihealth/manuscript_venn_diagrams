...
the other group are enriched in gene sets which which correspond to the
...
This manuscript has been written in Rmarkdown [@xie2018r].  
All statistical calculations required to replicate the findings and figures
are contained in the source Rmarkdown file.  The Rmarkdown file, along with
